...
@Component({
  selector: 'app-parent-charts',
  templateUrl: './parent-charts.component.html',
  styleUrls: ['./parent-charts.component.scss']
})
export class ParentChartsComponent implements OnInit {
...
public optionsHistogram5: any = {};
  ...
  LoadChart(){
    ...
    this.service.DrawParentChart(model)
    .subscribe((resp:any)=>{
